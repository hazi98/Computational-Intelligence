...
\hypersetup{
            pdftitle={Time Series Forecasting using Polynomial Artificial Neural Networks},
            pdfkeywords={PANN, Time series forecasting, Neural
Networks},
            pdfborder={0 0 0},
            breaklinks=true}
...
\title{Time Series Forecasting using Polynomial Artificial Neural
Networks}
...
Yoltic Jassiel García
Guzmán %% -- end for/affiliation.institution.author
}
...
% in the abstract
\begin{abstract}
The Polynomial Artificial Neural network is a different approach to a
design of a universal structure identificator, which uses a statistical
method to adapt to a structure by means of maximum likehood techniques,
giving an efficient design for data forecasting in high performance
computing where the model is complex in nature.
\end{abstract}

% keywords
\begin{IEEEkeywords}
PANN; Time series forecasting; Neural Networks
\end{IEEEkeywords}
...
0.0074\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
Increasing \(\text{maxpow}\) does not benefit the result\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.02\columnwidth}\centering
5\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\centering
...
0.0099\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
\(e_\text{train}\downarrow, e_\text{test} \uparrow\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.02\columnwidth}\centering
6\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\centering
