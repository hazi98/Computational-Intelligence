...
for i=1:nhijin
    ...
    %tnal=length(naleatbin);%tama�o del aleatorio binario
    %naleatbin0=zeros(1,nb);%vec de 0s del tama�o nb
    %for j=1:tnal%for para pasar los hijos a binario con el valor correcto
    %    %j+(nb-tnal)%j+nb(18)-tama�o del aleatorio binario, por ejemplo si tnal = 17 empieza desde la segunda casilla
...
while gen<ngen,
	...
	[hijosm]=mutabasen(hijos,porcent,nbase);%mutacion
